...
public class PurgeOldInvoicePDFJob  implements InterruptableJob
{
    ...
    public void execute(Context context) throws Exception {
        try {
            ...
            //Integer validityPeriod = configService.getInteger(IMConstants.NO_OF_DAYS_TO_PURGE_PROCESSED_FILE);
            String outputDirectoryPath = configService.getString(IMConstants.BASE_DESTINATION_FOLDER_PATH);
            int noOfDays = configService.getInteger(IMConstants.DELETE_INVOICE_PDF_BEFORE_NO_OF_DAYS);
