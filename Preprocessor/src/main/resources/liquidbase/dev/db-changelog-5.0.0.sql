...
Insert into IM_ATTACHMENT_CONFIG (ID,ATTACHMENT_NAME) values (1,'FIRSTTIME');
Insert into IM_ATTACHMENT_CONFIG (ID,ATTACHMENT_NAME) values (2,'FULLKONTROLL');
Insert into IM_ATTACHMENT_CONFIG (ID,ATTACHMENT_NAME) values (3,'OTHERS');
